    ...
    <div className="flex-1 flex flex-col bg-slate-950 text-slate-100 min-h-screen">
      ...
      <main className="flex-1 p-4 space-y-4 max-w-md mx-auto w-full pb-24">
        ...
        <div>
          ...
          <h1 className="text-xl font-bold font-pixel text-white">Inventory</h1>
        </div>
        ...
        <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 space-y-2.5">
          <div className="flex items-center justify-between text-xs text-slate-400">
            ...
            <span className="font-pixel text-slate-500">{initialData.activeCount} Barang</span>
          </div>
              ...
              <div className="h-2 w-full bg-slate-950 rounded-full overflow-hidden p-0.5 border border-slate-800">
                <div
                  ...
                  style={{
                    width: `${Math.min(
                      100,
                      Math.round((initialData.totalSaved / initialData.totalTarget) * 100)
                    )}%`,
                  }}
                />
              </div>
